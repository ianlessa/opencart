...
Funcionalidade: Instalação do módulo MundiPagg
    ...
    Cenário: Configurações gerais
        ...
        E seleciono "Enabled" de "CC-Visa"
        E seleciono "Enabled" de "CC-Mastercard"
        E seleciono "Enabled" de "CC-Amex"
        E seleciono "Enabled" de "CC-Diners"
        E seleciono "Enabled" de "CC-Elo"
        E seleciono "Enabled" de "CC-Hipercard"
        E sigo o link "Boleto"
        E clico no elemento "#boleto-enabled"
